...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Adicionar Usuários') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('usuarios/cadastrar') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Administrador') }}</label>

                            <div class="col-md-6">
                                <label class="toggle-switch">
                                    <input id="admin" class="" name="admin" value=true type="checkbox">
                                    <span class="slider"></span>
                                </label>
                            </div>
                        </div>
